...
import com.example.bustract.Driver.UpdateBusTrackingActivity
...
import com.example.bustract.databinding.ActivitySearchForBusBinding
...
class SearchForBus : AppCompatActivity(), Searchable {
    ...
    override fun Forintent(search: Search) {
      /*  if (search.distance != null) {*/
            Intent(this, UpdateBusTrackingActivity::class.java).apply {
                putExtra("routedetails", search)
                putExtra("vvv", search.vehiclenumber)
